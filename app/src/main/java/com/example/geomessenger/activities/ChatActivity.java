...
public class ChatActivity extends BaseActivity {
    ...
    private void listenAvailabilityOfReceiver(){
        database.collection(Constants.KEY_COLLECTION_USERS).document(
            ...
            if (isReceiverAvailable){
                findViewById(R.id.textAvailability).setVisibility(View.VISIBLE);
            } else  {
                findViewById(R.id.textAvailability).setVisibility(View.GONE);
            }
        });
    }
        ...
        if (value != null) {
            ...
            for(DocumentChange documentChange : value.getDocumentChanges()) {
                if(documentChange.getType() == DocumentChange.Type.ADDED) {
                    ...
                    if (chatMessage.senderId.equals(receiverUser.id)) {
                        chatMessage.conversionImage = receiverUser.image;
                    }
